...
const Header = () => {
  return (
    <header className="fixed top-0 w-full z-50 bg-black border-b-4 border-white">
      <div className="sm:px-8 flex h-16 max-w-7xl mr-auto ml-auto pr-5 pl-5 items-center justify-between">
        <div className="flex items-center gap-3">
          <div
            className="shrink-0 w-7 h-7 flex items-center justify-center border-2 border-white"
            aria-hidden="true"
          >
            {/* Lucide: sparkles */}
            <svg
              ...
              strokeWidth="1.5"
            >
              <path d="M12 3l1.3 3.3L16.5 8l-3.2 1.7L12 13l-1.3-3.3L7.5 8l3.2-1.7L12 3zM5 16l.9 2.3L8 19l-2.1 1.1L5 22l-.9-1.9L2 19l2.1-.7L5 16zm14-2l1.1 2.7L23 18l-2.9 1.3L19 22l-1.1-2.7L15 18l2.9-1.3L19 14z" />
            </svg>
          </div>
          <span
            className="sm:text-3xl js-glitch text-2xl font-extrabold tracking-tight"
        ...
        <Navbar />
        <button className="md:hidden inline-flex items-center gap-2 px-3 py-2 border-2 border-white text-sm font-semibold hover:bg-white hover:text-black transition">
          {/* Lucide: menu */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
